export const membrosData = {
  ...
  "davi": {
    ...
    resumo: [
      ...
      "Soft skills em gestão de pessoas, habilidades de liderança, distribuição de tarefas, comunicação eficaz e resolução de conflitos.",
      "Pioneiro na parceria com a A3EM (Associação de Antigos Alunos da Escola de Minas), parceria com a Start Carreiras, parceria com a Matta Automação e reaproximação das outras EJs da Escola de Minas."
    ],
    Habilidades: [
